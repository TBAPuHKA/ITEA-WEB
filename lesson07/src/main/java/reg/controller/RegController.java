...
public class RegController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher rd = req.getRequestDispatcher("WEB-INF/views/regFormView.jsp");
		rd.forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (!isError) {
			...
			rd = req.getRequestDispatcher("WEB-INF/views/regDoneView.jsp");	
			rd.forward(req, resp);
		} else {
			req.setAttribute("errorText", errorText.toString());
			rd = req.getRequestDispatcher("WEB-INF/views/regFormView.jsp");
		}
